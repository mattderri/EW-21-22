...
\end{proof}
Let's keep only the contribution coming from massless one-particle states and see if we can obtain some more information.\marginnote[-2cm]{For one-particle state we have $$\sum_n\to\int\frac{d^3p}{(2\pi)^3}\frac{1}{2E_p}$$ where $E_p$ is the energy of the single particle.}
\[
