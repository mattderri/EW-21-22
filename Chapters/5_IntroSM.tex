...
\[
\overline{Q}_L^ii\slashed{D}Q_L^i=\overline{Q}_L^ii\gamma^\mu\left(\partial_\mu-igW_\mu^i\frac{\sigma^i}{2}-ig'YB_\mu\right)Q_L^i
\]
We use the same substitution as before with $W_\mu^+$ and $W_\mu^-$ to write:
\[
\overline{Q}_L^ii\slashed{\partial}Q_L^i+\overline{Q}_L^i\gamma^\mu\left[\frac{g}{\sqrt{2}}(W_\mu^+\sigma^++W_\mu^-\sigma^-)+(gW_\mu^3T_3+g'B_\mu Y)\right]Q_L^i
\]
...
\begin{align*}
\overline{Q}_L^ii\slashed{D}Q_L=&\underbrace{\overline{Q}_L^ii\gamma^\mu(\partial_\mu-ieQA_\mu)Q_L}_{\text{photons interaction}}\\
...
&=-\frac{vY_u^{ij}}{\sqrt{2}}\left(1+\frac{h}{v}\right)\overline{u}_L^iu_R^j-\frac{vY_d^{ij}}{\sqrt{2}}\left(1+\frac{h}{v}\right)\overline{u}_L^id_R^j+\text{h.c}
\end{align*}
...
\[
\pazocal{L}_{\text{Yuk}}=-\overline{u}_i\mqty(\dmat{m_u,m_c,m_t})_{ij}u_j\left(1+\frac{h}{v}\right)+\text{h.c.}-\overline{d}_i\mqty(\dmat{m_d,m_s,m_b})_{ij}d_j\left(1+\frac{h}{v}\right)+\text{h.c.}
\]
