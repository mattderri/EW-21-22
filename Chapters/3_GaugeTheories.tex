...
&\delta\pazocal{L}_{\text{int}}=\partial_\mu\alpha^a(x)J^{\mu,a}(x)=\partial_\mu\alpha^a(x)\overline{\Psi}\gamma^\mu T^a(r)\Psi
\end{aligned}
\right.\\
&\text{Local G:}\left\{
\begin{aligned}
&\delta\pazocal{L}(\Psi)=\overline{\Psi}\gamma^\mu(i\Omega^{-1}\partial_\mu\Omega)\Psi\\
&\delta\pazocal{L}_{\text{int}}=\partial_\mu\alpha^a(x)\overline{\Psi}\gamma^\mu\Omega^{-1}T^a\Omega\Psi
\end{aligned}
\right.
\end{aligned}
\right.
...
\[
0=\delta\pazocal{L}(\Psi)+\delta\pazocal{L}_{\text{int}}=\overline{\Psi}\gamma^\mu(i\Omega^{-1}\partial_\mu\Omega+\partial_\mu\alpha^a(x)\Omega^{-1}T^a\Omega)\Psi
\]
\[
...
\[
\pazocal{L}(\Psi)=\overline{\Psi}(i\gamma^\mu D_\mu-m)\Psi
\]
