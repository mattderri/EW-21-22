...
\left\{
\begin{aligned}
&W^0=\frac{1}{2}(\epsilon^{0123}M_{12}k+\epsilon^{0213}M_{21}k)=M_{12}\cdot k=J_3\cdot k\\
...
\]
We are left with the kinetic term for $\Sigma$ which we have already encountered before, $\Tr{\Sigma\Sigma^\dagger}=2$ so the Lagrangian is obtained by plugging this expression in \refeq{lsigma}:
\[
