...
\]
We had to introduce a potential for $\varphi$, the so-called Mexican hat potential, already seen in \refsec{exSSB} with the linear U(1) Sigma model. This is known as the \textbf{Abelian Higgs model}.
\begin{figure}[h]
    \centering
...
\end{align*}\marginnote[-1cm]{For the part highlighted in red:
\begin{align*}
...
\end{align*}
The term with the total derivative gives a null contribution in the action, therefore we do not consider it.}
