...
For massive states, we make a clever choice and work in the reference system where the massive particle is at rest, i.e. $K^\mu=(m,0,0,0)$. The little group is SO(3), since rotations are the only proper orthochronous Lorentz transformations that leaves at rest a particle with zero momentum. We can use the generators $J^2$ and $J_z$ and, being SO(3) compact, the eigenvalues of its generators are quantized. We can prove that $J^2$ is proportional to the second Casimir $W^\mu=\frac{1}{2}\epsilon^{\mu\nu\rho\sigma}M_{\nu\rho}P_\sigma$. $\sigma$ must be a temporal index while all the other ones are spatial.
\[
...
\]
In QED, the corrections we have to include are electron self-energy, photon self-energy and vertex corrections which give us $\beta_0=4/3$ and $\beta(g)=g^3/12\pi^2$. \marginnote{\includegraphics{Images/corrections.pdf}\\
Electron self-energy, photon self-energy and vertex corrections.}
