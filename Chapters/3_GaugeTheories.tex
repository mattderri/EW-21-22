...
\end{align*}
Now that we have the Lagrangian, it is possible to compute the amplitude but of a special case: $\chi^a\chi^b\to\chi^a\chi^b$.\marginnote{\includegraphics[width=0.3\textwidth]{Images/abab.pdf}\\
