...
\newcommand\bigzero{\makebox(3,3){\text{\huge 0}}}
\newcommand\bigita{\makebox(3,3){\text{\huge $it^a$}}}
...
\lowertitleback{
	...
	\textbf{Publisher} \\
	First wrote in November 2022 by \@author\\
...
\subfile{Chapters/2_SymmetriesQFT}
\subfile{Chapters/3_GaugeTheories}
\subfile{Chapters/4_EFT}
\subfile{Chapters/5_IntroSM}
